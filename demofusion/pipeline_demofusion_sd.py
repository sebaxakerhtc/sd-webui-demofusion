...
class DemoFusionSDStableDiffusionPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromSingleFileMixin):
    r"""
            ...
            with self.progress_bar(total=num_inference_steps) as progress_bar:
                for i, t in enumerate(timesteps):
                    ...
                    for j, batch_view in enumerate(views_batch):
                        ...
                        # predict the noise residual
                        added_cond_kwargs = {"text_embeds": add_text_embeds_input}
                        noise_pred = self.unet(
                            latent_model_input,
                            t,
